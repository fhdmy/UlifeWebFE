<template>
  <v-content style="background: #f3f4f5;">
    ...
    <div class="search-choose-wrapper">
      <Searchchoose :target="target" :time="time" :type="type" :interest="interest" :content="content" :rank="rank"></Searchchoose>
    </div>
    <div class="home-maincontent-wrapper">
      <Searchkey @sendrank="sendrank" :target="target" :acts="searchacts" @sendmoreacts="sendmoreacts"></Searchkey>
      <Rank></Rank>
      <Actrank></Actrank>
