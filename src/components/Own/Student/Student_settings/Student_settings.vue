  ...
  <v-content style="background:white;">
    ...
    <div class="edit-wrapper">
      ...
      <Student-detail v-show="opt=='detail'" :mynickname.sync="name" :mycollege.sync="college" :mygrade.sync="grade" :userurl="userurl"
        :row.sync="gender"></Student-detail>
      <Student-avator v-show="opt=='avatar'" :userurl="userurl" :imgsrc.sync="img"></Student-avator>
      <Student-head-img v-show="opt=='head_img'" :userurl="userurl" :imgsrc.sync="bg_img"></Student-head-img>
      ...
      <Student-privacy-settings v-show="opt=='settings'" :userurl="userurl" :isfavpublic.sync="is_fav_public" :ishistorypublic.sync="is_history_public"
        :iswatchedorgspublic.sync="is_watched_orgs_public" :isvisitorpublic.sync="is_visitor_public"></Student-privacy-settings>
